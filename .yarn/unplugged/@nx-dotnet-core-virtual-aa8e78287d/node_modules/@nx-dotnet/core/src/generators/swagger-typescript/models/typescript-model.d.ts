export type TypeScriptRepresentation = TypeScriptInterface | TypeScriptArrayType;
...
export type TypeScriptProperty = TypeScriptLiteralProperty | TypeScriptObjectProperty;
