...
async function processCollectedUpdatedAndDeletedFiles() {
    try {
        ...
        if (workspaceConfigHash !== storedWorkspaceConfigHash) {
            ...
            ({ externalNodes: knownExternalNodes, ...exports.fileMapWithFiles } =
                await (0, retrieve_workspace_files_1.retrieveWorkspaceFiles)(workspace_root_1.workspaceRoot, nxJson));
        }
        else {
            if (exports.fileMapWithFiles) {
                exports.fileMapWithFiles = (0, file_map_utils_1.updateFileMap)(projectNodes, exports.fileMapWithFiles.fileMap, exports.fileMapWithFiles.allWorkspaceFiles, new Map(Object.entries(updatedFileHashes)), deletedFiles);
            }
            else {
                exports.fileMapWithFiles = await (0, retrieve_workspace_files_1.retrieveWorkspaceFiles)(workspace_root_1.workspaceRoot, nxJson);
            }
        }
...
async function createAndSerializeProjectGraph() {
    try {
        ...
        const projectConfigurations = await (0, retrieve_workspace_files_1.retrieveProjectConfigurations)(workspace_root_1.workspaceRoot, (0, nx_json_1.readNxJson)(workspace_root_1.workspaceRoot));
        ...
        const { projectGraph, projectFileMapCache } = await (0, build_project_graph_1.buildProjectGraphUsingProjectFileMap)(projectConfigurations.projectNodes, knownExternalNodes, fileMap, allWorkspaceFiles, exports.currentProjectFileMapCache || (0, nx_deps_cache_1.readFileMapCache)(), true);
