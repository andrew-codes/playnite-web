 ...
 */
export declare function loadNxPluginsSync(plugins: NxJsonConfiguration['plugins'], paths?: string[], root?: string): LoadedNxPlugin[];
export declare function loadNxPlugins(plugins: PluginConfiguration[], paths?: string[], root?: string): Promise<LoadedNxPlugin[]>;
