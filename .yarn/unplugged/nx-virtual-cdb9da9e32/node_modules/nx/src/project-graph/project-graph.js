...
async function buildProjectGraphWithoutDaemon() {
    ...
    const { allWorkspaceFiles, fileMap, projectConfigurations, externalNodes } = await (0, retrieve_workspace_files_1.retrieveWorkspaceFiles)(workspace_root_1.workspaceRoot, nxJson);
    const cacheEnabled = process.env.NX_CACHE_PROJECT_GRAPH !== 'false';
    const projectGraph = (await (0, build_project_graph_1.buildProjectGraphUsingProjectFileMap)(projectConfigurations.projects, externalNodes, fileMap, allWorkspaceFiles, cacheEnabled ? (0, nx_deps_cache_1.readFileMapCache)() : null, cacheEnabled)).projectGraph;
...
async function createProjectGraphAsync(opts = {
    ...
    if (!client_1.daemonClient.enabled()) {
        ...
        try {
            const projectGraph = await client_1.daemonClient.getProjectGraph();
