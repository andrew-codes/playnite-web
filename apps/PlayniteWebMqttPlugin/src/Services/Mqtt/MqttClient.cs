...
namespace PlayniteWebMqtt.Services.Mqtt
{
  internal class MqttClient : IConnectPublisher<IMqttClient>, IMqttClient
  {
    ...
    private readonly PlayniteWebMqttSettingsViewModel settings;
    private readonly Guid pluginId;
    private bool IsReconnectInProgress = false;
    private bool IsShutDownInProgress = false;

    public MqttClient(IMqttClient client, IManageTopics topicManager, string version, PlayniteWebMqttSettingsViewModel settings, Guid pluginId, ISerializeObjects serializer)
    {
      this.client = client;
